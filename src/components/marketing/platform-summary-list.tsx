...
import { summarizeByPlatform, weeklyFollowersByPlatform } from "@/lib/marketing/social-derive";
import { formatNumber } from "@/lib/format";
import { FollowersHistoryChart } from "@/components/marketing/followers-history-chart";
...
export function PlatformSummaryList() {
  ...
  return (
    <>
      ...
      {viewMode === "advanced" && <FollowersHistoryChart data={weeklyFollowersByPlatform(socialStats)} />}
    </>
  );
}
